...
enum opt_code
{
  ...
  OPT_mdiv = 1155,                           /* -mdiv */
  OPT_mexplicit_relocs = 1156,               /* -mexplicit-relocs */
  OPT_mfdiv = 1157,                          /* -mfdiv */
  OPT_mglibc = 1158,                         /* -mglibc */
  OPT_mmusl = 1159,                          /* -mmusl */
  OPT_mplt = 1160,                           /* -mplt */
  OPT_msave_restore = 1161,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1162,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1163,                  /* -mstrict-align */
  OPT_mtune_ = 1164,                         /* -mtune= */
  OPT_muclibc = 1165,                        /* -muclibc */
  OPT_n = 1166,                              /* -n */
  OPT_no_canonical_prefixes = 1167,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1168,              /* -no-integrated-cpp */
  OPT_no_pie = 1169,                         /* -no-pie */
  OPT_nocpp = 1170,                          /* -nocpp */
  OPT_nodefaultlibs = 1171,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1172,                   /* -nostartfiles */
  OPT_nostdinc = 1173,                       /* -nostdinc */
  OPT_nostdinc__ = 1174,                     /* -nostdinc++ */
  OPT_nostdlib = 1175,                       /* -nostdlib */
  OPT_o = 1176,                              /* -o */
  OPT_p = 1177,                              /* -p */
  OPT_pass_exit_codes = 1178,                /* -pass-exit-codes */
  /* OPT_pedantic = 1179, */                 /* -pedantic */
  OPT_pedantic_errors = 1180,                /* -pedantic-errors */
  OPT_pg = 1181,                             /* -pg */
  OPT_pie = 1182,                            /* -pie */
  OPT_pipe = 1183,                           /* -pipe */
  OPT_posix = 1184,                          /* -posix */
  ...
  OPT_profile = 1196,                        /* -profile */
  OPT_pthread = 1197,                        /* -pthread */
  OPT_quiet = 1198,                          /* -quiet */
  OPT_r = 1199,                              /* -r */
  OPT_rdynamic = 1200,                       /* -rdynamic */
  ...
  OPT_static_liblsan = 1214,                 /* -static-liblsan */
  OPT_static_libmpx = 1215,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1216,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1217,               /* -static-libstdc++ */
  OPT_static_libtsan = 1218,                 /* -static-libtsan */
  OPT_static_libubsan = 1219,                /* -static-libubsan */
  /* OPT_std_c__03 = 1220, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1221, */                /* -std=c++0x */
  OPT_std_c__11 = 1222,                      /* -std=c++11 */
  OPT_std_c__14 = 1223,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1224, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1225, */                /* -std=c++1y */
  OPT_std_c__1z = 1226,                      /* -std=c++1z */
  OPT_std_c__98 = 1227,                      /* -std=c++98 */
  OPT_std_c11 = 1228,                        /* -std=c11 */
  /* OPT_std_c1x = 1229, */                  /* -std=c1x */
  /* OPT_std_c89 = 1230, */                  /* -std=c89 */
  OPT_std_c90 = 1231,                        /* -std=c90 */
  OPT_std_c99 = 1232,                        /* -std=c99 */
  /* OPT_std_c9x = 1233, */                  /* -std=c9x */
  OPT_std_f2003 = 1234,                      /* -std=f2003 */
  OPT_std_f2008 = 1235,                      /* -std=f2008 */
  OPT_std_f2008ts = 1236,                    /* -std=f2008ts */
  OPT_std_f95 = 1237,                        /* -std=f95 */
  OPT_std_gnu = 1238,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1239, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1240, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1241,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1242,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1243, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1244, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1245,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1246,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1247,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1248, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1249, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1250,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1251,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1252, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1253, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1254,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1255, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1256, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1257, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1258,                     /* -std=legacy */
  OPT_symbolic = 1259,                       /* -symbolic */
  OPT_t = 1260,                              /* -t */
  OPT_time = 1261,                           /* -time */
  OPT_time_ = 1262,                          /* -time= */
  OPT_traditional = 1263,                    /* -traditional */
  OPT_traditional_cpp = 1264,                /* -traditional-cpp */
  OPT_trigraphs = 1265,                      /* -trigraphs */
  OPT_u = 1266,                              /* -u */
  OPT_undef = 1267,                          /* -undef */
  OPT_v = 1268,                              /* -v */
  OPT_version = 1269,                        /* -version */
  OPT_w = 1270,                              /* -w */
  OPT_wrapper = 1271,                        /* -wrapper */
  OPT_x = 1272,                              /* -x */
  OPT_z = 1273,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
